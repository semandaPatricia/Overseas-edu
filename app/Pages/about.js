...
import {
  ...
  const About = ({ testimonials }) => {
    const title = "About Us | Overseas Edu";
    const description =
      "Learn more about Overseas Education and our mission to help students apply to their dream universities with expert guidance and support from accomplished alumni and current students. Discover our free personalized counseling and courses today.";
    const keywords =
      "study abroad, personal guidance, free guidance, free counseling, free courses, apply to universities";
    const url = "https://www.overseasEdu.com/contacts";
      ...
      <div>
        ...
        <Container py="16" px={[4, 4]} maxW={["100vw", "100vw", "70vw"]}>
          <Heading
            ...
            as={"h2"}
          >
            Introducing Overseas Education Company
          </Heading>
  
          <Stack mt="5" spacing={4} fontWeight="light">
            <Text fontSize="lg">
              Welcome to Overseas! Are you ready to go on a courageous,
              self-discovering, empowering journey with Us?
            </Text>
            <Text fontWeight="normal">
              We are an organization that provides free guidance and
              ...
              <br />
              At Overseas, we believe that everyone deserves access to
