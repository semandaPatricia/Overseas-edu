...
const index = ({ testimonials }) => {
  ...
  const description =
    "Meet Semanda Solomon, Your Admission Guru | Leap Admission | Get expert guidance on studying abroad from him, your dedicated admission guru. With a GRE score of 316 and a master's degree in business analytics and project management from the University of Connecticut, Nilesh can help you navigate the admission process and secure scholarships. Contact Leap Admission today to schedule a consultation.";
  const image =
    "https://res.cloudinary.com/dltkycv3q/image/upload/v1676790441/Nilesh_Photo_tysumx.jpg";
  const keywords =
    "study abroad, admission guru, Semanda Solomon, GRE, scholarships, University of Connecticut, business analytics, project management";
  const url = "https://www.overseas.com/mentor";
        ...
        >
          ...
          <Box mt={{ base: 6, md: 0 }} ml={{ md: 6 }}>
            ...
            <Text mb={6} fontSize={{ base: "sm", md: "md" }} color="gray.500">
              As the Managing Director of Overseas Edu, I bring over a decade
