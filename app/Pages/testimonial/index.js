...
const TestimonialPage = ({ testimonials }) => {
  const title = "testimonials | Overseas";
  const description =
  ...
  const keywords =
    "testimonials, student reviews, Overseas reviews, counseling, guidance, education, study abroad";
  const url = "https://www.Overseas.com/testimonial";
